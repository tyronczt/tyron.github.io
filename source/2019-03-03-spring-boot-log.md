...
> **发表于**：2019-03-03　　**分类**：技术　　**标签**：springboot　　**原文**：[http://tyronblog.com/2019/03/03/spring-boot-log/](http://tyronblog.com/2019/03/03/spring-boot-log/)

---

日志框架、日志配置[示例代码](https://github.com/tyronczt/spring-boot-learning/tree/master/spring-boot-03-logging)

### 一、日志框架

市场上存在非常多的日志框架。 JUL（java.util.logging），JCL（Apache Commons Logging），Log4j，Log4j2，Logback、 SLF4j、 jboss-logging等。Spring Boot在框架内容部使用JCL，spring-boot-starter-logging采用了 **SLF4j 和 Logback** 的形式，Spring Boot也能自动适配（jul、 log4j2、 logback） 并简化配置 。
